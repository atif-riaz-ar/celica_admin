						...
						<div class="row">
							<div class="col-6">
								...
								<input class="form-control" type="text" name="member_id"
									   value="<?php echo $_POST['member_id'] ?>">
							</div>
							<div class="col-6">
								<label class=" control-label" for="txtGroupName">[[BONUS_TYPE]]</label>
								<select name="bonus" id="bonus" class="form-control">
									<option <?php echo $_POST['bonus'] == "ALL_BONUS" ? "selected='selected'" : ""; ?>
											value="ALL_BONUS">[[ALL_BONUS]]
									</option>
									<option <?php echo $_POST['bonus'] == "SPONSOR_BONUS" ? "selected='selected'" : ""; ?>
											value="SPONSOR_BONUS">[[SPONSOR_BONUS]]
									</option>
									<option <?php echo $_POST['bonus'] == "BINARY_BONUS" ? "selected='selected'" : ""; ?>
											value="BINARY_BONUS">[[BINARY_BONUS]]
									</option>
									<option <?php echo $_POST['bonus'] == "MATCHING_BONUS" ? "selected='selected'" : ""; ?>
											value="MATCHING_BONUS">[[MATCHING_BONUS]]
									</option>
									<option <?php echo $_POST['bonus'] == "RANKING_BONUS" ? "selected='selected'" : ""; ?>
											value="RANKING_BONUS">[[RANKING_BONUS]]
									</option>
									<option <?php echo $_POST['bonus'] == "MODEL_BONUS" ? "selected='selected'" : ""; ?>
							...
							<div class="col-6">
								...
								<select name="selyrfrom" id="year_start" class="form-control">
									...
									for ($year = date('Y'); $year > $defYear - 1; $year--) {
										$sel = $year == $_POST['selyrfrom'] ? ' selected="selected"' : '';
