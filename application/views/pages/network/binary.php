				...
				<div class="card-body group-scroll" id="refreshGTB">
					<div class="groupTreegoup">
						<a href="javascript:goUp()" style="float:left">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="corner-left-up" data-lucide="corner-left-up" class="lucide lucide-corner-left-up block mx-auto"><polyline points="14 9 9 4 4 9"></polyline><path d="M20 20h-7a4 4 0 01-4-4V4"></path></svg>
						</a>
					</div>
